...
export const moneyTrackerData = {
  ...
  header: {
    ...
    description:
      "ระบบติดตามรายรับ-รายจ่ายส่วนตัว ดึงข้อมูลธุรกรรมจากอีเมลแจ้งเตือนธนาคารอัตโนมัติ พร้อมแดชบอร์ดสรุปยอดคงเหลือแบบเรียลไทม์",
  ...
  tabsContent: {
    ...
    overview: {
      ...
      objectives: {
        title: "วัตถุประสงค์",
        content:
          "ลดภาระการบันทึกรายรับ-รายจ่ายด้วยมือ • ให้เห็นภาพรวมทางการเงินแบบเรียลไทม์ผ่านแดชบอร์ด • วางโครงสร้างระบบให้ขยายรองรับธนาคารอื่นเพิ่มได้ในอนาคต",
      },
    },
      ...
      items: [
        {
          ...
          description:
            "ดึงอีเมลแจ้งเตือนธุรกรรมใหม่ต่อจาก timestamp ล่าสุดโดยอัตโนมัติทุกครั้งที่เปิดแอป",
        },
        {
          title: "Email Parsing",
          description:
            "แกะข้อมูลรายการโอนเงินจาก HTML email ของธนาคารแต่ละแห่ง",
        },
        {
          title: "Duplicate Prevention",
          description:
            "ตรวจสอบ reference number ก่อนบันทึก ป้องกันรายการซ้ำลงฐานข้อมูล",
        },
        {
    ...
    technical: {
      ...
      details: {
        ...
        "Sync Strategy":
          "ดึงข้อมูลต่อจาก timestamp ล่าสุดทุกครั้งที่เปิดแอป (ไม่ใช่ cron job)",
    ...
    results: {
      ...
      items: [
        {
          ...
          description:
            "ระบบดึงข้อมูลอัตโนมัติทุกครั้งที่เปิดแอปโดยอ้างอิงจาก timestamp ล่าสุด และใช้ติดตามการเงินส่วนตัวจริง",
        },
        {
          title: "[รอเพิ่มเติม]",
      ...
      futureGoals: {
        ...
        items: [{ description: "[รอเพิ่มเติม] จะเพิ่มเป้าหมายในอนาคตทีหลัง" }],
      },
    },
  },
};
