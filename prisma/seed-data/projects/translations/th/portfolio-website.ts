...
export const portfolioWebsiteData = {
  ...
  header: {
    ...
    description:
      "เว็บไซต์แสดงผลงานส่วนตัวที่รองรับหลายภาษา สร้างด้วย Next.js และ TypeScript พร้อมระบบ Dark Mode",
    tags: [
      "2025",
      "เว็บไซต์",
      "ส่วนตัว",
  ...
  tabsContent: {
    ...
    overview: {
      ...
      objectives: {
        title: "วัตถุประสงค์",
        content:
          "สร้างตัวตนออนไลน์ที่เป็นมืออาชีพ • แสดงความสามารถในการใช้เทคโนโลยีใหม่ • เป็นช่องทางในการติดต่อกับนายจ้างและลูกค้า • ฝึกฝนทักษะการพัฒนา Frontend",
      },
    },
      ...
      items: [
        {
          ...
          description:
            "รองรับ 3 ภาษา: ไทย, อังกฤษ, ญี่ปุ่น พร้อมระบบเปลี่ยนภาษาแบบ Real-time",
        },
        {
      ...
      challenges: {
        ...
        items: [
          ...
          },
          {
            ...
            description:
              "ทำให้ website ทำงานง่ายและเข้าถึงได้สำหรับผู้ใช้ทุกคน",
          },
          {
    ...
    results: {
      ...
      items: [
        ...
        },
        {
          ...
          description:
            "เชี่ยวชาญ Next.js, TypeScript และ Modern Web Development",
        },
        {
      ...
      futureGoals: {
        ...
        items: [
          {
            description:
              "เพิ่มโปรเจกต์ใหม่ๆใน Portfolio ที่มีการใช้งานเป็นไปตามเป้าหมาย",
          },
        ],
      },
    },
