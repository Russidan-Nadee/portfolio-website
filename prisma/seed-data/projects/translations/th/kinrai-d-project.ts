...
export const kinraiDData: ProjectData = {
  ...
  header: {
    title: "Kinrai-D",
    description:
      "แอปพลิเคชันสุ่มอาหารแบบข้ามแพลตฟอร์มที่ช่วยให้ผู้ใช้ค้นหาอาหารใหม่ๆ ได้อย่างสนุกสนาน",
  ...
  tabsContent: {
    ...
    overview: {
      ...
      objectives: {
        title: "วัตถุประสงค์",
        content:
          "สร้างแอปพลิเคชันที่ช่วยให้ผู้ใช้ตัดสินใจเลือกอาหารได้ง่ายขึ้น ด้วยระบบสุ่มอาหาร การกรองตาม filter และระบบ Dislike เพื่อให้ได้เมนูที่ถูกใจ พร้อมระบบ Admin สำหรับจัดการเมนูและรองรับผู้ใช้หลายภาษา",
      },
    },
    features: {
      title: "ฟีเจอร์หลัก",
      items: [
        {
          title: "Guest Login",
          description:
            "เข้าใช้งานแอปได้ทันทีโดยไม่ต้องสมัครสมาชิก รองรับการใช้งานแบบไม่ระบุตัวตน",
        },
        {
          title: "ระบบสุ่มอาหาร",
          description:
            'สุ่มเมนูอาหารจากฐานข้อมูลได้อย่างง่ายดาย ช่วยแก้ปัญหา "กินอะไรดี" ในทุกวัน',
        },
        {
          title: "ระบบ Dislike",
          description:
            "กด Dislike เพื่อข้ามเมนูที่ไม่ชอบและสุ่มอาหารใหม่ได้ทันที",
        },
        {
          title: "กรองอาหารตาม Filter",
          description:
            "กรองเมนูอาหารตามหมวดหมู่และตัวเลือกที่ผู้ใช้กำหนดเอง เพื่อผลลัพธ์ที่ตรงใจ",
        },
        {
          title: "Admin Menu",
          description:
            "ระบบจัดการสำหรับแอดมินในการเพิ่ม ลด และแก้ไขเมนูอาหารในฐานข้อมูล",
        },
        {
          title: "รองรับหลายภาษา",
          description:
            "ระบบ i18n รองรับหลายภาษา ให้ผู้ใช้จากทั่วโลกใช้งานได้อย่างสะดวก",
        },
      ],
    },
    gallery: {
        ...
        items: [
          {
            ...
            description:
              "ออกแบบระบบ authentication ที่รองรับทั้งผู้ใช้ทั่วไปและ Guest โดยไม่กระทบสิทธิ์ระหว่างกัน",
          },
          {
            title: "Logic การกรองและ Dislike",
            description:
              "พัฒนาระบบ filter และ dislike ที่ทำงานร่วมกันได้อย่างถูกต้องและมีประสิทธิภาพ",
          },
          {
            title: "ระบบหลายภาษาข้ามแพลตฟอร์ม",
            description:
              "สร้างระบบ i18n ที่ทำงานสม่ำเสมอบน iOS, Android และ Web",
          },
        ],
      },
    },
      ...
      items: [
        {
          ...
          description:
            "พัฒนาแอปพลิเคชันที่ทำงานได้บน iOS, Android และ Web อย่างราบรื่น",
        },
        {
          title: "ระบบสุ่มพร้อม Dislike & Filter",
          description:
            "ระบบสุ่มอาหารที่ผสานกับ Dislike และ Filter ช่วยให้ได้เมนูที่ตรงใจผู้ใช้จริงๆ",
        },
        {
          title: "Admin Dashboard",
          description:
            "ระบบ Admin สำหรับจัดการเมนูอาหารในฐานข้อมูลได้อย่างสะดวก",
        },
        {
          title: "รองรับหลายภาษา",
          description:
            "แอปรองรับหลายภาษา ให้ผู้ใช้จากทั่วโลกสามารถใช้งานได้อย่างสะดวกสบาย",
        },
      ],
      futureGoals: {
        ...
        items: [
          {
            description:
              "เพิ่มฟีเจอร์แนะนำอาหารด้วย AI ตามประวัติ Dislike และ Filter ของผู้ใช้",
          },
          {
            description:
              "พัฒนาระบบ User Account เต็มรูปแบบ พร้อมบันทึกประวัติการสุ่ม",
          },
          {
            description:
              "เพิ่มเมนูอาหารนานาชาติและขยายฐานข้อมูลให้ครอบคลุมมากขึ้น",
          },
          {
