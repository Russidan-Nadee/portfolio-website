// src/data/projects/translations/th/tp-rfid.ts
  ...
  tabsContent: {
    ...
    overview: {
      ...
      objectives: {
        title: "วัตถุประสงค์",
        content:
          "นำไปใช้งานภายในแผนกเพื่อทดสอบประสิทธิภาพและปรับปรุงระบบ • อนาคตหากระบบทำงานได้ดี จะขยายการใช้งานไปยังทั้งบริษัทเพื่อเพิ่มประสิทธิภาพในการจัดการทรัพย์สินโดยรวม",
      },
    },
    ...
    features: {
      ...
      items: [
        ...
        },
        {
          title: "Search",
          description:
            "ค้นหาทรัพย์สินด้วยเลขครุภัณฑ์, ชื่อ, หรือหมวดหมู่ หรือข้อมูลอื่นๆที่เกี่ยวข้อง",
        },
        {
          title: "Export",
        ...
        },
        {
          title: "Setting",
          description:
            "ตั้งค่าระบบ, จัดการผู้ใช้งาน และกำหนดสิทธิ์การเข้าถึง ภาษา และธีม",
        },
        {
          title: "Sync",
        ...
        items: [
          {
            ...
            description:
              "การทำให้ระบบทำงานได้สม่ำเสมอบนทุกแพลตฟอร์ม (Mobile, Web, Desktop)",
          },
          {
            title: "RFID Integration",
            description:
              "การเชื่อมต่อกับอุปกรณ์ RFID Reader และการประมวลผลข้อมูล Tag",
          },
          {
          ...
          },
          {
            ...
            description:
              "การปรับปรุงประสิทธิภาพฐานข้อมูลเมื่อข้อมูลทรัพย์สินมีจำนวนมาก",
          },
          {
            title: "User Experience",
            description:
              "การออกแบบ UI/UX ที่ใช้งานง่ายและตอบสนองได้ดีบนทุกอุปกรณ์",
          },
        ],
      },
    },
      ...
      items: [
        {
          title: "สถานะการพัฒนา",
          description:
            "โปรเจคอยู่ระหว่างการพัฒนา (Phase 1) คาดว่าจะเสร็จสมบูรณ์ในไตรมาส 4/2025",
        },
        {
          title: "การประหยัดค่าใช้จ่าย",
          description:
            "คาดการณ์ว่าจะประหยัดค่าซื้อซอฟต์แวร์ภายนอกได้มากกว่า ≈76.21%",
        },
        {
        ...
        },
        {
          ...
          description:
            "ได้รับ Feedback เชิงบวกจากผู้ใช้งานเรื่องความสะดวกและใช้งานง่าย",
        },
      ],
      futureGoals: {
        ...
        items: [
          {
            description:
              "ขยายการใช้งานไปยังทั้งบริษัทหากผลการทดสอบใน Department เป็นไปตามเป้าหมาย",
          },
          { description: "เพิ่มระบบความปลอดภัยขั้นสูง" },
          {
            description:
              "เชื่อมต่อกับระบบ ERP ของบริษัทเพื่อการจัดการแบบรวมศูนย์",
          },
          {
            description:
              "พัฒนาระบบแจ้งเตือนเมื่อทรัพย์สินมีการเปลี่ยนแปลงสถานะ",
          },
