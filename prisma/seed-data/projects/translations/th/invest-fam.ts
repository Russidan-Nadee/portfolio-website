...
export const investFamData: ProjectData = {
  ...
  header: {
    title: "InvestFam",
    description:
      "แพลตฟอร์มครบครันสำหรับการวางแผนการเงินและเครื่องมือคำนวณการลงทุนฟรี",
    tags: [
      "2025",
      "เว็บไซต์",
      "ส่วนตัว",
  ...
  tabsContent: {
    ...
    overview: {
      ...
      objectives: {
        title: "วัตถุประสงค์",
        content:
          "สร้างแพลตฟอร์มที่ให้เครื่องมือการเงินฟรีและเข้าถึงง่าย เพื่อช่วยให้ผู้ใช้สามารถวางแผนการเงินและการลงทุนได้อย่างมีประสิทธิภาพ",
      },
    },
    features: {
      title: "ฟีเจอร์หลัก",
      items: [
        {
          ...
          description:
            "คำนวณผลตอบแทนจากการลงทุนกองทุนรวมพร้อมค่าธรรมเนียมต่างๆ",
        },
        {
        ...
        items: [
          {
            ...
            description:
              "สร้างอัลกอริธึมสำหรับการคำนวณผลตอบแทนและค่าธรรมเนียมที่แม่นยำ",
          },
          {
            title: "การออกแบบ UX ที่เข้าใจง่าย",
            description:
              "ออกแบบให้ผู้ใช้ทั่วไปเข้าใจเครื่องมือทางการเงินได้ง่าย",
          },
          {
      ...
      items: [
        {
          ...
          description:
            "สร้างเว็บแอปพลิเคชันที่มีเครื่องมือคำนวณทางการเงินครบครัน พร้อมใช้งานจริง",
        },
        {
          title: "การเข้าถึงที่ง่าย",
          description:
            "ให้บริการเครื่องมือการเงินฟรีที่ใครๆ ก็สามารถเข้าถึงได้",
        },
        {
