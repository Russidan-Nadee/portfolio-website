...
export const calculatorData = {
  ...
  header: {
    ...
    description:
      "เครื่องคิดเลขที่มีฟีเจอร์ครบครัน สร้างด้วย Python และ Tkinter พร้อม UI ที่ใช้งานง่าย",
    tags: [
      "2025",
      "แอปเดสก์ท็อป",
      "การศึกษา",
  ...
  tabsContent: {
    ...
    overview: {
      ...
      objectives: {
        title: "วัตถุประสงค์",
        content:
          "เรียนรู้การพัฒนา Desktop Application ด้วย Python • ฝึกใช้ Tkinter สำหรับสร้าง GUI • ทำความเข้าใจ Event Handling และ User Input Validation",
      },
    },
    ...
    results: {
      ...
      items: [
        {
          ...
          description:
            "สามารถสร้างแอปเครื่องคิดเลขที่ใช้งานได้จริงและมีฟีเจอร์ครบครัน",
        },
        {
          title: "ทักษะที่ได้รับ",
          description:
            "พัฒนาการใช้ภาษา Python และการพัฒนา GUI ด้วย Tkinter ให้มีประสิทธิภาพมากขึ้น",
        },
        {
          title: "การใช้งาน",
      ...
      futureGoals: {
        ...
        items: [
          {
            description:
              "เพิ่มการใช้งานให้ง่ายขึ้นดเหมือนการใช้งานเครื่องคิดเลขราคาแพง",
          },
        ],
      },
    },
