  ...
  tabsContent: {
    ...
    overview: {
      ...
      objectives: {
        title: "วัตถุประสงค์",
        content:
          "เพิ่มฝึกฝนการพัฒนาแอปพลิเคชันมือถือแบบครบวงจร • ลดเวลาในการตรวจสอบและบันทึกข้อมูล • สร้าง Mobile Experience ที่ดีสำหรับเจ้าหน้าที่",
      },
    },
    ...
    features: {
      ...
      items: [
        ...
        },
        {
          ...
          description:
            "อัพเดทสถานะทรัพย์สินและซิงค์กับเซิร์ฟเวอร์แบบ Real-time",
        },
        {
      ...
      challenges: {
        ...
        items: [
          ...
          },
          {
            ...
            description:
              "การซิงค์ข้อมูลระหว่าง Mobile App และ Backend Server แบบ Real-time",
          },
          {
            title: "UI/UX Design",
            description:
              "การออกแบบ UI ที่ใช้งานง่ายและตอบสนองได้ดีบนอุปกรณ์มือถือ",
          },
          {
            title: "Performance Optimization",
            description:
              "การปรับปรุงประสิทธิภาพของแอปให้ทำงานได้รวดเร็วและราบรื่น",
          },
          {
      ...
      items: [
        {
          ...
          description:
            "ลดเวลาในการตรวจสอบทรัพย์สินจาก 5-10 นาที เหลือ 1-2 นาที ต่อรายการ",
        },
        {
        ...
        },
        {
          ...
          description:
            "เรียนรู้การพัฒนา Backend API ที่เชื่อมต่อกับฐานข้อมูล MySQL",
        },
        {
          title: "เรียนรู้การทำระบบ Authentication ด้วย JWT",
          description:
            "เรียนรู้การทำระบบล็อกอินและการยืนยันตัวตนด้วย JWT Token",
        },
      ],
      futureGoals: {
