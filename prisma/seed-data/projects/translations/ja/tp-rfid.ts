// src/data/projects/translations/ja/tp-rfid.ts
...
export const assetDashboardData = {
  ...
  header: {
    title: "TP RFID",
    description:
      "RFIDテクノロジーを使用した包括的な資産管理システムで、コスト削減と効率向上を実現",
    tags: [
      "2025",
      "Cross-platform",
      "Enterprise",
  ...
  tabsContent: {
    ...
    overview: {
      ...
      objectives: {
        title: "目的",
        content:
          "部門内に展開してシステムの効率をテストし、改善する • 将来的に、システムが良好に動作すれば、全社に使用を拡大して全体的な資産管理効率を向上させる",
      },
    },
      ...
      items: [
        {
          title: "ダッシュボード",
          description:
            "資産統計とデータをグラフィカル形式で表示するダッシュボード",
        },
        {
          title: "スキャン",
          description:
            "RFIDタグをスキャンして情報を表示し、資産ステータスを更新",
        },
        {
          title: "検索",
          description:
            "資産番号、名前、カテゴリ、またはその他の関連情報で資産を検索",
        },
        {
          title: "エクスポート",
        ...
        },
        {
          title: "設定",
          description:
            "システム設定の構成、ユーザー管理とアクセス権限、言語とテーマ",
        },
        {
          title: "同期",
        ...
        items: [
          {
            ...
            description:
              "すべてのプラットフォーム（モバイル、ウェブ、デスクトップ）で一貫したシステムパフォーマンスを確保",
          },
          {
            title: "RFID統合",
          ...
          },
          {
            title: "データベースパフォーマンス",
            description:
              "大量の資産データを扱う際のデータベースパフォーマンスの最適化",
          },
          {
            title: "ユーザーエクスペリエンス",
            description:
              "すべてのデバイスでユーザーフレンドリーでレスポンシブなUI/UXの設計",
          },
        ],
      },
    },
      ...
      items: [
        {
          title: "開発ステータス",
          description:
            "プロジェクトは現在開発中（フェーズ1）で、2025年第4四半期に完了予定",
        },
        {
          title: "コスト削減",
        ...
        },
        {
          title: "UX/UIフレンドリー",
          description:
            "便利さと使いやすさについてユーザーから好意的なフィードバックを受領",
        },
      ],
      futureGoals: {
        title: "将来の目標",
