...
export const kinraiDData: ProjectData = {
  ...
  header: {
    title: "Kinrai-D",
    description:
      "ユーザーが楽しく新しい料理を発見できるクロスプラットフォーム食品ランダマイザーアプリ",
  ...
  tabsContent: {
    ...
    overview: {
      ...
      objectives: {
        title: "目的",
        content:
          "ランダム化・フィルター・Dislikeシステムを通じてユーザーが食事の決断を簡単に行えるアプリを作成し、Admin Panelによるメニュー管理と多言語対応でグローバルな利用を可能にする。",
      },
    },
    features: {
      title: "主な機能",
      items: [
        {
          title: "ゲストログイン",
          description:
            "登録不要でアプリにすぐアクセス可能、匿名ユーザーセッションをサポート",
        },
        {
          title: "食品ランダム化",
          description:
            "ワンタップでデータベースからランダムに食事を選択、毎日の食事の悩みを解消",
        },
        {
          title: "Dislikeシステム",
          description:
            "Dislikeをタップして不要な料理をスキップし、すぐに新しいランダム提案を表示",
        },
        {
          title: "フィルター機能",
          description:
            "ユーザーが選択したカテゴリや好みでフィルタリングし、より関連性の高い提案を表示",
        },
        {
          title: "Admin Menu",
          description:
            "データベースの食品アイテムを追加・削除・編集できるAdmin管理画面",
        },
        {
          title: "多言語対応",
          description:
            "組み込みi18nシステムで複数言語をサポート、世界中のユーザーが利用可能",
        },
      ],
    },
    gallery: {
        ...
        items: [
          {
            title: "ゲストログインシステム",
            description:
              "登録ユーザーとゲストの両方をデータ競合なくサポートする認証設計",
          },
          {
            title: "フィルター＆Dislike ロジック",
            description:
              "Dislike除外システムと組み合わせた正確でパフォーマンスの高いフィルタリングの構築",
          },
          {
            title: "クロスプラットフォーム多言語対応",
            description:
              "iOS・Android・Webプラットフォーム全体で一貫したi18n動作の確保",
          },
        ],
      },
    },
      ...
      items: [
        {
          ...
          description:
            "iOS、Android、Webプラットフォームでスムーズに動作するアプリケーションを開発",
        },
        {
          title: "ランダム化・Dislike・フィルター",
          description:
            "ランダム化・Dislike・フィルターが連携して、ユーザーが本当に食べたい料理を提示",
        },
        {
          title: "Admin ダッシュボード",
        ...
        },
        {
          title: "多言語サポート",
          description:
            "完全なi18nサポートにより、さまざまな国のユーザーが快適に利用可能",
        },
      ],
      futureGoals: {
        title: "将来の目標",
        items: [
          {
            description:
              "DislikeデータとフィルターをもとにしたAI食品推奨機能の追加",
          },
          {
            description:
              "ランダム化履歴追跡機能を持つフルユーザーアカウントシステムの開発",
          },
          {
