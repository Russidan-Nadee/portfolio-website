...
export const moneyTrackerData = {
  ...
  header: {
    ...
    description:
      "銀行の通知メールから取引データを自動取得する個人向け家計簿アプリ。リアルタイムの残高ダッシュボード付き",
  ...
  tabsContent: {
    ...
    overview: {
      ...
      objectives: {
        title: "目的",
        content:
          "収支の手入力の手間を削減する • ダッシュボードでリアルタイムに家計を把握できるようにする • 将来的に対応銀行を追加しやすい構造にする",
      },
    },
      ...
      items: [
        {
          title: "Gmail自動取得",
          description:
            "アプリを開くたびに、最後に保存したタイムスタンプ以降の新着取引メールを自動取得",
        },
        {
          title: "メール解析",
    ...
    results: {
      ...
      items: [
        {
          title: "日常的に運用中",
          description:
            "アプリを開くたびに最後のタイムスタンプ以降を自動取得し、実際の家計管理に活用されている",
        },
        {
          title: "[追記予定]",
      ...
      futureGoals: {
        title: "将来の目標",
        items: [{ description: "[追記予定] 将来の目標は後日追記します" }],
      },
    },
  },
};
