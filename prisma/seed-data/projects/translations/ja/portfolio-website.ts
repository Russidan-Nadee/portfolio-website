...
export const portfolioWebsiteData = {
  ...
  header: {
    ...
    description:
      "Next.jsとTypeScriptで構築された多言語対応の個人ポートフォリオウェブサイトで、ダークモード機能付き",
    tags: [
      "2025",
      "ウェブサイト",
      "個人",
  ...
  tabsContent: {
    ...
    overview: {
      ...
      objectives: {
        title: "目的",
        content:
          "プロフェッショナルなオンラインプレゼンスの作成 • 新技術使用能力の実証 • 雇用者やクライアントとの連絡チャネルの提供 • フロントエンド開発スキルの練習",
      },
    },
      ...
      items: [
        {
          title: "多言語サポート",
          description:
            "3つの言語をサポート：タイ語、英語、日本語でリアルタイム言語切り替え",
        },
        {
          title: "ダーク/ライトモード",
        ...
        },
        {
          title: "レスポンシブデザイン",
          description:
            "モバイル、タブレット、コンピューターで良好に動作するよう設計",
        },
        {
        ...
        items: [
          {
            title: "多言語実装",
            description:
              "多言語データとダイナミックコンテンツローディングの管理",
          },
          {
            title: "パフォーマンス最適化",
            description:
              "高速読み込みとSEOフレンドリーなパフォーマンスの最適化",
          },
          {
            title: "ユーザーフレンドリーなUI",
            description:
              "すべてのユーザーが使いやすくアクセスしやすいウェブサイトの作成",
          },
          {
            title: "レスポンシブレイアウト",
