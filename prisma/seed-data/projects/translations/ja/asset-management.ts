  ...
  tabsContent: {
    ...
    overview: {
      ...
      objectives: {
        title: "目的",
        content:
          "包括的なモバイルアプリケーション開発の練習 • データチェックと記録の時間短縮 • スタッフ向けの良いモバイルエクスペリエンスの創出",
      },
    },
      ...
      challenges: {
        ...
        items: [
          ...
          },
          {
            title: "データ同期",
            description:
              "モバイルアプリとバックエンドサーバー間のリアルタイムデータ同期",
          },
          {
            title: "UI/UXデザイン",
            description:
              "モバイルデバイス用のユーザーフレンドリーでレスポンシブなUIの設計",
          },
          {
            title: "パフォーマンス最適化",
            description:
              "高速でスムーズな動作のためのアプリパフォーマンスの最適化",
          },
          {
