...
export const calculatorData = {
  ...
  header: {
    title: "高度な電卓アプリ",
    description:
      "PythonとTkinterで構築された機能豊富な電卓で、使いやすいUIを備えています",
    tags: [
      "2025",
      "デスクトップアプリ",
      "教育",
  ...
  tabsContent: {
    ...
    overview: {
      ...
      objectives: {
        title: "目的",
        content:
          "Pythonでのデスクトップアプリケーション開発を学習 • GUI作成のためのTkinterの練習 • イベントハンドリングとユーザー入力検証の理解",
      },
    },
    ...
    results: {
      ...
      items: [
        ...
        },
        {
          title: "コード品質",
          description:
            "コードは良い構造、明確な分離、ドキュメンテーションを持つ",
        },
      ],
      futureGoals: {
        title: "開発計画",
        items: [{ description: "高価な電卓のような使いやすさの向上" }],
      },
    },
  },
};
