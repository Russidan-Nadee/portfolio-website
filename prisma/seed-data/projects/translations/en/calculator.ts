...
export const calculatorData = {
  ...
  header: {
    ...
    description:
      "Feature-rich calculator built with Python and Tkinter with user-friendly UI",
    tags: ["2025", "Desktop App", "Education", "Tools", "Scientific", "Memory"],
    demoUrl:
      "https://github.com/Russidan-Nadee/python-calculator/releases/download/v1.0/Python-Calculator.exe",
  ...
  tabsContent: {
    ...
    overview: {
      ...
      objectives: {
        title: "Objectives",
        content:
          "Learn Desktop Application development with Python • Practice using Tkinter for GUI creation • Understand Event Handling and User Input Validation",
      },
    },
        ...
        items: [
          {
            ...
            description:
              "Making the interface responsive to rapid button presses",
          },
          {
          ...
          },
          {
            ...
            description:
              "Preventing errors from division by zero and invalid input",
          },
          {
      ...
      items: [
        {
          ...
          description:
            "Successfully created a functional calculator app with comprehensive features",
        },
        {
          title: "Skills Gained",
          description:
            "Improved Python language skills and GUI development with Tkinter",
        },
        {
          title: "Usage",
        ...
        },
        {
          title: "Code Quality",
          description:
            "Code has good structure, clear separation, and documentation",
        },
      ],
      futureGoals: {
