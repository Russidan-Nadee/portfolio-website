...
export const portfolioWebsiteData = {
  ...
  header: {
    ...
    description:
      "Multilingual personal portfolio website built with Next.js and TypeScript featuring Dark Mode",
    tags: [
      "2025",
      "Website",
      "Personal",
  ...
  tabsContent: {
    ...
    overview: {
      ...
      objectives: {
        title: "Objectives",
        content:
          "Create a professional online presence • Demonstrate ability to use new technologies • Provide a channel for contacting employers and clients • Practice Frontend development skills",
      },
    },
      ...
      items: [
        {
          ...
          description:
            "Support for 3 languages: Thai, English, Japanese with real-time language switching",
        },
        {
          title: "Dark/Light Mode",
          description:
            "Theme switcher that changes themes according to preference",
        },
        {
        ...
        items: [
          {
            ...
            description:
              "Managing multilingual data and Dynamic Content Loading",
          },
          {
            title: "Performance Optimization",
            description:
              "Optimizing performance for fast loading and SEO-friendly",
          },
          {
            title: "User-friendly UI",
            description:
              "Making the website easy to use and accessible for all users",
          },
          {
    ...
    results: {
      ...
      items: [
        ...
        },
        {
          ...
          description:
            "Mastered Next.js, TypeScript and Modern Web Development",
        },
        {
          title: "Professional Portfolio",
          description:
            "Have a website that demonstrates capabilities and serves as a good representative",
        },
        {
          title: "Performance Score",
          description:
            "Achieved high Lighthouse scores in SEO and Accessibility",
        },
      ],
      futureGoals: {
