...
export const investFamData: ProjectData = {
  ...
  header: {
    title: "InvestFam",
    description:
      "Your comprehensive hub for smart financial planning and investment decisions",
    tags: [
      "2025",
      "Website",
      "Personal",
  ...
  tabsContent: {
    ...
    overview: {
      ...
      objectives: {
        title: "Objectives",
        content:
          "Create a free and accessible financial tools platform that helps users plan their finances and investments effectively",
      },
    },
    features: {
      title: "Key Features",
      items: [
        {
          ...
          description:
            "Calculate mutual fund investment returns with detailed fee inputs",
        },
        {
          title: "DCA Calculator",
          description:
            "Calculate returns from Dollar Cost Averaging investment strategy",
        },
        {
        ...
        },
        {
          ...
          description:
            "Calculate loan payments and interest for financial planning",
        },
        {
        ...
        items: [
          {
            ...
            description:
              "Create accurate algorithms for investment returns and fee calculations",
          },
          {
            title: "User-Friendly UX Design",
            description:
              "Design financial tools that are easy to understand for general users",
          },
          {
            title: "Multi-language Support",
            description:
              "Provide comprehensive service in both Thai and English",
          },
        ],
      },
    },
      ...
      items: [
        {
          ...
          description:
            "Created a complete web application with comprehensive financial calculation tools ready for real use",
        },
        {
        ...
        },
        {
          ...
          description:
            "Designed UI/UX that is easy to use and understand for general users",
        },
      ],
      futureGoals: {
        title: "Future Goals",
        items: [
          ...
          {
            description:
              "Develop features for saving and tracking financial data",
          },
          {
