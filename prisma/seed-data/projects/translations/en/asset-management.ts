  ...
  tabsContent: {
    ...
    overview: {
      ...
      objectives: {
        title: "Objectives",
        content:
          "Practice developing comprehensive mobile applications • Reduce time for data checking and recording • Create a good mobile experience for staff",
      },
    },
        ...
        items: [
          {
            ...
            description:
              "Managing secure login system and identity verification",
          },
          {
            title: "Data Synchronization",
            description:
              "Real-time data synchronization between Mobile App and Backend Server",
          },
          {
            title: "UI/UX Design",
            description:
              "Designing user-friendly and responsive UI for mobile devices",
          },
          {
            title: "Performance Optimization",
            description:
              "Optimizing app performance for fast and smooth operation",
          },
          {
      ...
      items: [
        {
          title: "Work Speed",
          description:
            "Reduced asset checking time from 5-10 minutes to 1-2 minutes per item",
        },
        {
          title: "Data Accuracy",
        ...
        },
        {
          ...
          description:
            "Learned Backend API development connected to MySQL database",
        },
        {
          title: "Learning Authentication System with JWT",
          description:
            "Learned login system and identity verification with JWT Token",
        },
      ],
      futureGoals: {
