...
export const assetDashboardData = {
  ...
  header: {
    title: "TP RFID",
    description:
      "Comprehensive asset management system using RFID technology to reduce costs and improve efficiency",
    tags: [
      "2025",
      "Cross-platform",
      "Enterprise",
  ...
  tabsContent: {
    ...
    overview: {
      ...
      objectives: {
        title: "Objectives",
        content:
          "Deploy within the department to test efficiency and improve the system • In the future, if the system performs well, expand usage throughout the company to enhance overall asset management efficiency",
      },
    },
      ...
      items: [
        {
          title: "Dashboard",
          description:
            "Dashboard displaying asset statistics and data in graphical format",
        },
        {
          title: "Scan",
          description:
            "Scan RFID tags to view information and update asset status",
        },
        {
          title: "Search",
          description:
            "Search assets by asset number, name, category, or other related information",
        },
        {
          title: "Export",
        ...
        },
        {
          title: "Settings",
          description:
            "Configure system settings, manage users and access permissions, language and theme",
        },
        {
          title: "Sync",
        ...
        items: [
          {
            ...
            description:
              "Ensuring consistent system performance across all platforms (Mobile, Web, Desktop)",
          },
          {
            title: "RFID Integration",
            description:
              "Connecting with RFID Reader devices and processing tag data",
          },
          {
          ...
          },
          {
            ...
            description:
              "Optimizing database performance when dealing with large amounts of asset data",
          },
          {
            title: "User Experience",
            description:
              "Designing UI/UX that is user-friendly and responsive across all devices",
          },
        ],
      },
    },
      ...
      items: [
        {
          ...
          description:
            "Project is currently in development (Phase 1) expected to be completed in Q4/2025",
        },
        {
          title: "Cost Savings",
          description:
            "Expected to save over ≈76.21% on external software purchasing costs",
        },
        {
        ...
        },
        {
          ...
          description:
            "Received positive feedback from users regarding convenience and ease of use",
        },
      ],
      futureGoals: {
        title: "Future Goals",
        items: [
          {
            description:
              "Expand usage to the entire company if department testing results meet targets",
          },
          { description: "Implement advanced security systems" },
          {
            description:
              "Integrate with company ERP system for centralized management",
          },
          {
