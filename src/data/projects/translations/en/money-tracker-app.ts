...
export const moneyTrackerData = {
   ...
   header: {
      ...
      description: "A personal expense tracker that automatically pulls transaction data from bank notification emails, with a real-time balance dashboard",
   ...
   tabsContent: {
      ...
      overview: {
         ...
         objectives: {
            title: "Objectives",
            content: "Reduce the manual effort of logging income and expenses • Provide a real-time overview of personal finances through a dashboard • Build a structure that can be extended to support more banks in the future"
         }
      },
         ...
         items: [
            {
               ...
               description: "Automatically fetches new transaction emails since the last saved timestamp every time the app is opened"
            },
            {
               title: "Email Parsing",
               description: "Parses transaction data from each bank's HTML notification emails"
            },
            {
               title: "Duplicate Prevention",
               description: "Checks a unique reference number before saving to avoid duplicate records"
            },
            {
               title: "Multi-bank Support",
               description: "Supports notification emails from Krungthai and Kasikornbank"
            },
            {
               title: "Balance Dashboard",
               description: "Shows balances per account along with an income/expense summary"
            },
            {
               title: "Transaction Table",
               description: "Lists all transactions with color-coded income and expense amounts"
            }
         ]
      },
      ...
      technical: {
         ...
         challenges: {
            ...
            items: [
               {
                  title: "[To be added]",
                  description: "Challenge details for this project will be added later"
               }
            ]
         }
      },
      ...
      results: {
         ...
         items: [
            {
               title: "In Daily Use",
               description: "Automatically fetches new data every time the app is opened, based on the last saved timestamp, and is actively used to track real personal finances"
            },
            {
               title: "[To be added]",
