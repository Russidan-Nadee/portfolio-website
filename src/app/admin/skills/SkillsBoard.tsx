...
export default function SkillsBoard({
  ...
  const openRenameCategory = (category: CategoryData) =>
    setEditingCategory({ id: category.id, name: category.name });
  const openCreateCategory = () =>
    setEditingCategory({ id: "", name: blankCategoryName });
              ...
              <div>
                ...
                <div className="grid grid-cols-3 gap-3">
                  {(["th", "en", "ja"] as const).map((locale) => (
                    <div key={locale}>
                      <label
                        htmlFor={`skill-description-${locale}`}
                ...
                <div className="flex flex-col gap-2 mb-2">
                  ...
                  >
                    <input
                      type="checkbox"
                      name="featured"
                      defaultChecked={editingSkill.featured}
                    />
                    <span>Featured</span>
                  </label>
                  <label
                  ...
                  >
                    <input
                      type="checkbox"
                      name="active"
                      defaultChecked={editingSkill.active}
                    />
