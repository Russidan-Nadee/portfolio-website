// src/app/portfolio/money-tracker-app/page.tsx
'use client'
...
export default function MoneyTrackerAppPage() {
   ...
   const projectImagePath = '/images/projects/money-tracker-app/dashboard-overview.png'

   // Load project data based on language
   useEffect(() => {
      const loadData = async () => {
         setLoading(true)
         const data = await getProjectData('money-tracker-app', locale)
         setProjectData(data)
         setLoading(false)
      }
      loadData()
   ...
   const handleShare = () => {
      if (navigator.share) {
         navigator.share({
            ...
            text: 'ระบบติดตามรายรับ-รายจ่ายส่วนตัวอัตโนมัติ',
         ...
         <div className="min-h-screen flex items-center justify-center" style={{ backgroundColor: 'var(--background)' }}>
            <div className="text-center">
               ...
               <p style={{ color: 'var(--muted-foreground)' }}>
                  Money Tracker App project data is not available.
               </p>
            </div>
         </div>
      )
