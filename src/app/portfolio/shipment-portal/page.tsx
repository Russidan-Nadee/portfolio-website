// src/app/portfolio/shipment-portal/page.tsx
'use client'
...
export default function ShipmentPortalPage() {
   ...
   const projectImagePath = '/images/projects/shipment-portal/overview.png'

   // Load project data based on language
   useEffect(() => {
      const loadData = async () => {
         setLoading(true)
         const data = await getProjectData('shipment-portal', locale)
         setProjectData(data)
         setLoading(false)
      }
      loadData()
   ...
   const handleShare = () => {
      if (navigator.share) {
         navigator.share({
            ...
            text: 'พอร์ทัลติดตามและจัดการพัสดุสำหรับเจ้าหน้าที่ FastShip',
         ...
         <div className="min-h-screen flex items-center justify-center" style={{ backgroundColor: 'var(--background)' }}>
            <div className="text-center">
               ...
               <p style={{ color: 'var(--muted-foreground)' }}>
                  Shipment Portal project data is not available.
               </p>
            </div>
         </div>
      )
