// src/app/portfolio/master-data-service/page.tsx
'use client'
...
export default function MasterDataServicePage() {
   ...
   const projectImagePath = '/images/projects/master-data-service/swagger-overview.png'

   // Load project data based on language
   useEffect(() => {
      const loadData = async () => {
         setLoading(true)
         const data = await getProjectData('master-data-service', locale)
         setProjectData(data)
         setLoading(false)
      }
      loadData()
   ...
   const handleShare = () => {
      if (navigator.share) {
         navigator.share({
            ...
            text: 'Backend microservice สำหรับ shipping rate, currency rate และ geoname data',
         ...
         <div className="min-h-screen flex items-center justify-center" style={{ backgroundColor: 'var(--background)' }}>
            <div className="text-center">
               ...
               <p style={{ color: 'var(--muted-foreground)' }}>
                  Master Data Service project data is not available.
               </p>
            </div>
         </div>
      )
