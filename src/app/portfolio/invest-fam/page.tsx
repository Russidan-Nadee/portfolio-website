// src/app/portfolio/invest-fam/page.tsx
'use client'
...
export default function InvestFamPage() {
   ...
   useEffect(() => {
      const loadData = async () => {
         setLoading(true)
         const data = await getProjectData('invest-fam', locale)
         setProjectData(data)
         setLoading(false)
      }
      loadData()
   ...
   const handleShare = () => {
      if (navigator.share) {
         navigator.share({
            title: 'InvestFam Project',
            text: 'Financial Planning and Investment Calculator Platform',
         ...
         <div className="min-h-screen flex items-center justify-center" style={{ backgroundColor: 'var(--background)' }}>
            <div className="text-center">
               ...
               <p style={{ color: 'var(--muted-foreground)' }}>
                  InvestFam project data is not available.
               </p>
            </div>
         </div>
      )
