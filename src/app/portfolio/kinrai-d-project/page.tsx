// src/app/portfolio/kinrai-d-project/page.tsx
'use client'
...
export default function KinraiDPage() {
   ...
   useEffect(() => {
      const loadData = async () => {
         setLoading(true)
         const data = await getProjectData('kinrai-d-project', locale)
         setProjectData(data)
         setLoading(false)
      }
      loadData()
   ...
   const handleShare = () => {
      if (navigator.share) {
         navigator.share({
            title: 'Kinrai-D Project',
            text: 'Cross-Platform Food Randomizer App',
         ...
         <div className="min-h-screen flex items-center justify-center" style={{ backgroundColor: 'var(--background)' }}>
            <div className="text-center">
               ...
               <p style={{ color: 'var(--muted-foreground)' }}>
                  Kinrai-D project data is not available.
               </p>
            </div>
         </div>
      )
   ...
   return (
      <div className="min-h-screen" style={{ backgroundColor: 'var(--background)' }}>
         ...
         <div className="max-w-6xl mx-auto p-5">
            {/* Navigation Header */}
            <ProjectNavigation data={projectData.navigation} locale={locale} />
